...
import org.ladysnake.blabber.impl.common.RecursiveCodec;
...
public final class DialogueIllustrationType<T extends DialogueIllustration> {
    ...
    private static <T> Codec<T> withAlternative(final Codec<T> primary, final Codec<? extends T> alternative) {
        return Codec.either(
                primary,
                alternative
        ).xmap(
